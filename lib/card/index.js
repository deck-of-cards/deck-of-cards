...
export class Card extends Entity {
  ...
  startMove (e) {
    if (this._movingGroup) {
      this.group.game.add(this.group, false);
    } else {
      if (this.group) {
        this.group.game.add(this.group, false);
      } else {
        this.game.add(this, false);
      }
    }
  }
    ...
    if (this._movingGroup) {
      ...
      if (this.group) {
        ...
        if (closest.children) {
          ...
          pile.x = closest.x;
          pile.y = closest.y;
          pile.add(closest, false);
          pile.add(this, true);
          this.game.add(pile, false);
        }
      }
    }
  }
